...
const Setting2 = () => {
  ...
  // === GHÉP ẢNH THEO ĐÚNG LOGIC SELPHOTO ===
  ...
  const handleSampleUpload = (e) => {
    ...
    reader.onload = (ev) => {
      ...
      const config = getMaxPhotos(selectedFrame.cuts);
      const photos = Array(config).fill(photo);
    ...
    <div className="setting2-root">
      ...
      <div className="setting2-scroll-container">
        <div className={`setting2-container ${sidebarCollapsed ? 'sidebar-collapsed' : ''}`}>
          {/* HEADER, CONTROLS, TABLE, PAGINATION - GIỮ NGUYÊN */}
