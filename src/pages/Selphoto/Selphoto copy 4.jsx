...
const SelPhoto = () => {
  ...
  // State cho stickers trên preview image
  ...
  // ✅ NEW: Xử lý thêm sticker vào ảnh preview
  ...
  const handleStickerScale = (stickerId, delta) => {
    setPlacedStickers(prev => prev.map(s =>
      s.id === stickerId
  ...
  // Xử lý xoay sticker
  const handleStickerRotate = (stickerId, delta) => {
    setPlacedStickers(prev => prev.map(s =>
      s.id === stickerId
  ...
  // Render stickers đã đặt trên canvas
        ...
        {placedStickers.map(sticker => (
          <div
            ...
            style={{
              ...
              cursor: 'move',
              zIndex: selectedStickerId === sticker.id ? 1000 : 100,
            ...
            {selectedStickerId === sticker.id && (
              <div className="sticker-controls">
                <button
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    handleStickerScale(sticker.id, 0.1);
                  }}
                  title="Phóng to"
                >
                  +
              ...
              {loadingStickers ? (
                ...
                filteredStickers.map(sticker => (
                  <div
                    ...
                    onClick={() => { handleAddSticker(sticker); handleAddStickerToPreview(sticker); }}
                  >
...
//chạy thành công khi cho sticker 
