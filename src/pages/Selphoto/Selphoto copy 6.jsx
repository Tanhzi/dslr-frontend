...
const SelPhoto = () => {
  ...
  // XÁC NHẬN STICKER - ẨN CÁC NÚT ĐIỀU KHIỂN
        ...
        >
          {slot ? (
            <div className="position-relative" style={{ width: '100%', height: '100%' }}>
              ...
              {/* Hiển thị stickers trên thumbnail */}
...
// file tách component con 
// thành các ile riêng biệt