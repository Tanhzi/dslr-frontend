...
const SelPhoto = () => {
  ...
  const [originalImages, setOriginalImages] = useState({}); // Lưu ảnh gốc trước khi enhance
  const [sliderPosition, setSliderPosition] = useState(50); // Vị trí thanh kéo (%)
  ...
  const handleEnhanceImage = async (index) => {
    ...
    try {
      ...
      if (res.ok && data.success) {
        // Lưu ảnh gốc trước khi enhance (nếu chưa có)
        ...
        // Reset slider về giữa khi enhance xong
  ...
  // Kiểm tra xem ảnh hiện tại có được enhance chưa
            ...
            <div className="selected-image-preview mb-4" style={{
              ...
              {hasEnhancedImage ? (
                ...
                >
                  ...
                  {/* Ảnh đã enhance (overlay với clip-path) */}
                  <div
                    style={{
                      position: 'absolute',
                      top: 0,
                ...
                /* Hiển thị ảnh bình thường khi chưa enhance */
                <img
                  src={selectedSlots[selectedImageIndex].photo}
                  alt="Preview"
                  style={{
                      ...
                      {filter ? (
                        <button
                          ...
                          style={{
                            ...
                            border: '1px solid',
                            borderColor: appliedFilters[selectedImageIndex] === filter.id ? '#ec4899' : '#ec4899',
                            whiteSpace: 'nowrap',
                            overflow: 'hidden',
